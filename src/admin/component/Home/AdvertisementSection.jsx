...
export default function AdvertisementSection() {
  ...
  const handleBackgroundUpload = (e) => {
    ...
    if (file) {
      setAdData({ ...adData, backgroundFile: file });
  ...
  const handleSubmit = () => {
    ...
    alert("Advertisement section saved successfully!");
  };
  ...
  return (
    <div className="w-full max-w-6xl mt-6  mx-auto bg-white border border-gray-200 rounded-lg shadow-sm">
      {/* Header */}
      <div
      ...
      {isExpanded && (
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex space-x-4">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    ...
                    name="backgroundType"
                    value="image"
                    checked={adData.backgroundType === "image"}
                    onChange={(e) => {
                      handleInputChange("backgroundType", e.target.value);
                      setBackgroundPreview(null);
                      setAdData({ ...adData, backgroundType: e.target.value, backgroundFile: null });
                    }}
                ...
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    ...
                    name="backgroundType"
                    value="video"
                    checked={adData.backgroundType === "video"}
                    onChange={(e) => {
                      handleInputChange("backgroundType", e.target.value);
                      setBackgroundPreview(null);
                      setAdData({ ...adData, backgroundType: e.target.value, backgroundFile: null });
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-gray-700">
                Background {adData.backgroundType === "video" ? "Video" : "Image"}
              </label>
              <div className="relative">
                <input
                  type="file"
                  accept={adData.backgroundType === "video" ? "video/*" : "image/*"}
                    ...
                    {backgroundPreview ? (
                      ...
                      <>
                        ...
                        <span className="text-sm text-gray-500">
                          Click to upload {adData.backgroundType}
                        </span>
                      </>
                    )}
                  </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input  
                  type="text"
                  placeholder="Enter main heading (e.g., 'Special Offer')"
                  value={adData.mainHeading}
                  onChange={(e) => handleInputChange("mainHeading", e.target.value)}
            ...
            <div className="space-y-2">
              ...
              <input
                type="text"
                placeholder="Enter sub heading (e.g., 'Get 50% off on all books')"
                value={adData.subHeading}
            ...
            <div className="space-y-2">
              ...
              <input
                type="text"
                placeholder="Enter button text (e.g., 'Shop Now', 'Learn More')"
                value={adData.buttonText}
          ...
          {/* Preview Section */}
          {(adData.mainHeading || adData.subHeading || adData.buttonText || backgroundPreview) && (
            <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="relative w-full h-64 bg-gray-900 rounded-lg overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center text-white p-6">
                  {adData.mainHeading && (
                    <h1 className="text-4xl font-bold mb-2">{adData.mainHeading}</h1>
                  )}
                  {adData.subHeading && (
                    <p className="text-xl mb-4">{adData.subHeading}</p>
                  )}
                  {adData.buttonText && (
